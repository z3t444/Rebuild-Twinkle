  ...
  return (
    <>
      <div className="flex mt-32 gap-8 justify-center">
        <div className="card-feature p-6 rounded-[35px] hover:scale-105 duration-300 shadow-2xl shadow-sky-300 h-60 w-52 bg-gradient-to-br from-[#91edff] to-[#07b9df]">
        ...
        <div className="card-feature p-6 rounded-[35px] hover:scale-105 duration-300 shadow-2xl shadow-gray-900 h-60 w-52 bg-gradient-to-br from-[#4a4f4e] to-[#1a1a1c]">
        ...
        <div className="card-feature p-6 rounded-[35px] hover:scale-105 duration-300 shadow-2xl shadow-[#f7505a] bg-gradient-to-br h-60 w-52 from-[#ff909b] to-[#f7505a]">
        ...
        <div className="card-feature p-6 rounded-[35px] hover:scale-105 duration-300 bg-gradient-to-br shadow-2xl shadow-[#0647c4] from-[#2d9cf6] to-[#0647c4] h-60 w-52">
        ...
        <div className="card-feature p-6 rounded-[35px] hover:scale-105 duration-300 bg-gradient-to-br from-[#fcae48] to-[#dd7d0f] shadow-2xl shadow-[#dc7d0e] h-60 w-52">
